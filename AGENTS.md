...
- **Config**: `mcp_enabled` (default false), `mcp_port` (default 8766). Settings Page 1 has an MCP section (below fixedline): Enable MCP Server checkbox, Port field, "Localhost only, no auth." label. No separate tab.
